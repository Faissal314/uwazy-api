...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // use a dedicated CORS configuration source bean
                ...
                .headers(headers -> headers.frameOptions(frame -> frame.disable())) // Allow iframes for PDF viewing
    ...
    /**
     * A permissive CORS configuration used by the security filter chain.
     *
     * Add the front‑end origin(s) here or switch to "*" for development.
     */
    @Bean
